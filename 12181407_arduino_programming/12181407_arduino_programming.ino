...
//YopTube Link: https://youtu.be/6P340-Y-MLc
//File name : 12181407_arduino_programming.ino
//<설명>
...
void loop()
{
	...
	switch (data_in) //switch문으로 입력값에 해당되는 결과를 실행
	{
	...
	case '2': //입력값이 1인 경우
		t = 250; //LED가 한 칸 이동하는 시간을 500ms로 변경
		break;

	case '3': //입력값이 1인 경우
		t = 125; //LED가 한 칸 이동하는 시간을 500ms로 변경
		break;
	
	case '4': //입력값이 1인 경우
		t = 62; //LED가 한 칸 이동하는 시간을 500ms로 변경
		break;
